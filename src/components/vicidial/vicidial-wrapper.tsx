        ...
        <CardContent className="h-full flex flex-col gap-4 p-4">
          ...
          {onStartSession != null && onEndSession != null ? (
            <div className="flex items-center gap-2 flex-wrap">
              <span className="text-xs uppercase font-medium text-muted-foreground">Agent State</span>
              <Button
          ...
          <div className="flex flex-col md:flex-row gap-4">
           <div className="flex-1 space-y-3">
             <div className="text-xs uppercase font-medium text-muted-foreground">Manual Dial</div>
           ...
           <div className="w-full md:w-56 space-y-3">
             <div className="text-xs uppercase font-medium text-muted-foreground">Active Call</div>
          ...
          <div className="border-t pt-4 space-y-3">
           <div className="flex items-center justify-between gap-2">
             <div className="text-xs uppercase font-medium text-muted-foreground">Disposition</div>
           </div>
